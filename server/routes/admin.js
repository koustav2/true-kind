...
const { User, Donation, Certificate, CertificateIssue, SiteContent, FormConfig } = require('../models');
...
router.get('/', async (req, res) => {
  const [active, guests, rows] = await Promise.all([
  ...
  res.render('admin/dashboard', { title: 'Admin', active, guests, donations });
});
